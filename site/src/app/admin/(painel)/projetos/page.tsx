      ...
      {projetos.length === 0 ? (
        ...
        <ul className="flex flex-col border-t border-(--border)">
          {projetos.map((projeto) => (
            ...
            >
              <span className="relative flex h-16 w-20 shrink-0 items-center justify-center overflow-hidden border border-(--border) bg-paper-3">
                {projeto.capa_url ? (
                  <Image
              ...
              <div className="flex min-w-0 flex-1 flex-col gap-1.5">
                ...
                <p className="flex flex-wrap items-center gap-x-3 gap-y-1 text-micro uppercase tracking-[0.12em] text-(--fg-subtle)">
                  ...
                  {!projeto.publicado ? (
                    <span className="font-semibold text-danger">Oculto</span>
                  ) : null}
                </p>
              </div>
