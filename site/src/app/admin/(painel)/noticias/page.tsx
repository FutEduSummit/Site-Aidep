...
import { apagarNoticia, publicarNoticia } from '../../acoes'
      ...
      {noticias.length === 0 ? (
        ...
        <ul className="flex flex-col border-t border-(--border)">
          {noticias.map((noticia) => {
            /* A mesma capa que o site publica — a enviada pelo painel ou,
               na falta dela, a fotografia do acervo registrada para esta
               notícia (ver `lib/admin/capas.ts`). */
            ...
            return (
              ...
              >
                <span
                  className="relative flex h-14 w-24 shrink-0 items-center justify-center overflow-hidden border border-(--border) bg-paper-3"
